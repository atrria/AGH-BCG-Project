...
void RotarySolidsSelectionFrame::SelectionFrameOnUpdateUI( wxUpdateUIEvent& event )
{
	mainFrame->Repaint(false);
	Update();
}
...
mainFrame->setSolidRoundnessLevel(wxAtoi(numOfContoursTextCtrl->GetValue()));
