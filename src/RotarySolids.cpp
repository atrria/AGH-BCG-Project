...
MainFrame::MainFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	xSlider->Connect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Connect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Connect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Connect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Connect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Connect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Connect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Connect( wxEVT_SCROLL_TOP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	yLabel->Connect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( MainFrame::yLabelOnLeftDClick ), NULL, this );
	ySlider->Connect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Connect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Connect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Connect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Connect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Connect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Connect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Connect( wxEVT_SCROLL_TOP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zLabel->Connect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( MainFrame::zLabelOnLeftDClick ), NULL, this );
	zSlider->Connect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Connect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Connect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Connect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Connect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Connect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Connect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Connect( wxEVT_SCROLL_TOP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
...
MainFrame::~MainFrame()
{
	...
	xSlider->Disconnect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Disconnect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Disconnect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Disconnect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Disconnect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Disconnect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Disconnect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Disconnect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	xSlider->Disconnect( wxEVT_SCROLL_TOP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	yLabel->Disconnect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( MainFrame::yLabelOnLeftDClick ), NULL, this );
	ySlider->Disconnect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Disconnect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Disconnect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Disconnect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Disconnect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Disconnect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Disconnect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Disconnect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	ySlider->Disconnect( wxEVT_SCROLL_TOP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zLabel->Disconnect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( MainFrame::zLabelOnLeftDClick ), NULL, this );
	zSlider->Disconnect( wxEVT_SCROLL_BOTTOM, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Disconnect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Disconnect( wxEVT_SCROLL_LINEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Disconnect( wxEVT_SCROLL_LINEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Disconnect( wxEVT_SCROLL_PAGEDOWN, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Disconnect( wxEVT_SCROLL_PAGEUP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Disconnect( wxEVT_SCROLL_THUMBRELEASE, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Disconnect( wxEVT_SCROLL_THUMBTRACK, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
	zSlider->Disconnect( wxEVT_SCROLL_TOP, wxScrollEventHandler( MainFrame::xyzSliderUpdated ), NULL, this );
